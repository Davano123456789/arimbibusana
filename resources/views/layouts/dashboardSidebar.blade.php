<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl fixed-start ms-4" id="sidenav-main" style="height: auto; min-height: calc(100vh - 2rem); margin-top: 1rem;">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="{{ url('/dashboard') }}">
      <img src="{{ asset('images/logo-arimbi.png') }}" width="26" height="26" class="navbar-brand-img h-100 rounded-circle object-cover" alt="logo">
  ...
  <div class="collapse navbar-collapse w-auto h-auto pb-4" id="sidenav-collapse-main" style="overflow: visible !important;">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ Request::is('dashboard/loyalty-settings*') ? 'active' : '' }}" href="{{ route('dashboard.loyalty.index') }}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fa-solid fa-coins text-warning text-sm"></i>
          </div>
          <span class="nav-link-text ms-1">Loyalty Points</span>
        </a>
      </li>
      <li class="nav-item">
