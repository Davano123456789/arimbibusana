...
@section('title', 'Edit Blog — Arimbi Busana')
                            ...
                            <div class="card shadow-none border">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="mb-3">
                                            <div id="preview-thumbnail" class="border-radius-lg border mb-2 d-flex align-items-center justify-content-center" style="width: 100%; height: 200px; overflow: hidden; background: #f8f9fa;">
                                                <img id="img-preview" src="{{ $blog->thumbnail ? asset('storage/' . $blog->thumbnail) : '' }}" style="width: 100%; height: 100%; object-fit: cover; {{ $blog->thumbnail ? '' : 'display: none;' }}">
                                                <i id="placeholder-icon" class="fas fa-image text-secondary opacity-5 fa-3x" style="{{ $blog->thumbnail ? 'display: none;' : '' }}"></i>
                                            </div>
                                            <input class="form-control" type="file" id="thumbnail" name="thumbnail" accept="image/*" onchange="previewImage(this)">
                                            <p class="text-xs text-secondary mt-2">Biarkan kosong jika tidak ingin mengubah thumbnail.</p>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="author" class="form-control-label">Penulis / Author</label>
                                        <input class="form-control" type="text" id="author" name="author" value="{{ $blog->author }}" required>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="{{ route('dashboard.blogs.index') }}" class="btn btn-outline-secondary w-100 mt-2">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </div>
