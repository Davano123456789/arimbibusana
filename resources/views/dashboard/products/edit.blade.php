                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="size-container">
                                ...
                                <div class="row size-row mb-3">
                                    <div class="col-md-5">
                                        <input type="text" name="sizes[]" class="form-control" value="{{ $size->size }}" placeholder="Ukuran (S, M, L, XL, atau All Size)" required>
                                    </div>
                                    <div class="col-md-5">
                                        <input type="number" name="size_stocks[]" class="form-control" value="{{ $size->stock }}" placeholder="Jumlah Stok" required min="0">
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-outline-danger btn-icon-only remove-size w-100" {{ $product->sizes->count() == 1 ? 'disabled' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" placeholder="Jelaskan detail produk, bahan, ukuran, dll.">{{ old('description', $product->description) }}</textarea>
                            </div>
                        </div>
