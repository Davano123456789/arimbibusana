...
@section('content')
        ...
        <div class="relative h-[55vh] md:h-[65vh] w-full overflow-hidden bg-black">
            ...
            <div class="max-w-6xl mx-auto px-6 h-full flex items-center">
                <div class="max-w-2xl text-white drop-shadow-lg" data-aos="fade-up">
                    <span
                        class="inline-block mb-3 bg-amber-100 text-accent px-3 py-1 rounded-full text-sm font-medium">Suara
                        Pelanggan</span>
                    <h1 class="text-4xl md:text-6xl font-bold leading-tight mb-4">Testimoni<br>Pelanggan</h1>
                    <p class="mb-6 text-white/90 max-w-lg">Kepercayaan Anda adalah kebanggaan kami. Simak cerita nyata dari
                        pelanggan setia Arimbi Queen.</p>
                    <a href="#tulis-ulasan"
    ...
    <main class="max-w-6xl mx-auto px-6 -mt-10 relative z-10">
        ...
        <section class="mt-12 grid grid-cols-3 gap-4 md:gap-8" data-aos="fade-up">
            ...
            <div class="text-center bg-white rounded-2xl shadow-sm border border-gray-50 py-6 px-4">
                <p class="text-3xl md:text-4xl font-bold text-accent font-serif">{{ number_format($avgRating, 1) }}<span
                        class="text-amber-400 text-2xl">★</span></p>
        ...
        <section class="mt-16" data-aos="fade-up">
            ...
            @if($testimonials->isEmpty())
                ...
                <div class="text-center py-24 bg-white rounded-3xl border border-gray-100 shadow-sm" data-aos="fade-up">
                    ...
                    <p class="text-gray-500 text-sm max-w-xs mx-auto mb-6">Jadilah yang pertama berbagi pengalaman berbelanja di
                        Arimbi Queen!</p>
                    <a href="#tulis-ulasan"
                        class="inline-flex items-center gap-2 btn-cream-dark px-6 py-3 rounded-full font-semibold shadow-lg">
                    ...
                    @foreach($testimonials as $i => $testi)
                        <div class="testi-card bg-white rounded-2xl shadow-sm hover:shadow-md border border-gray-50 p-7 flex flex-col"
                            ...
                            <div class="flex items-start gap-4 mb-5">
                                ...
                                @else
                                    <div
                                        class="w-14 h-14 rounded-full bg-gradient-to-br from-[#B78A58] to-[#5B3A29] flex items-center justify-center text-white text-xl font-bold flex-shrink-0 ring-2 ring-amber-100">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <div class="flex gap-0.5 mt-1.5">
                                        @for($s = 1; $s <= 5; $s++)
                                            <i
                                                class="fa-solid fa-star text-xs {{ $s <= $testi->rating ? 'rating-star' : 'rating-star empty' }}"></i>
                                        @endfor
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 flex items-center justify-between">
                                <span
                                    class="inline-flex items-center gap-1 bg-amber-50 text-amber-600 text-xs font-semibold px-3 py-1 rounded-full">
            ...
            <div class="form-section rounded-3xl p-8 md:p-12">
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="text-center mb-10">
                        <span
                            class="inline-block bg-white text-[#B78A58] border border-amber-200 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">Berbagi
                            Pengalaman</span>
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Tulis Ulasan Anda</h2>
                        <p class="text-sm text-gray-500">Ulasan Anda sangat berarti bagi pelanggan lain dan membantu kami
                            terus berkembang.</p>
                    </div>

                    <form action="{{ url('/testimoni') }}" method="POST" enctype="multipart/form-data" class="space-y-6"
                        ...
                        <div class="grid sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2" for="product_id">
                                    <i class="fa-solid fa-tag text-[#B78A58] mr-1"></i> Pilih Produk <span
                                        class="text-red-400">*</span>
                                </label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-3">
                                <i class="fa-solid fa-star text-[#B78A58] mr-1"></i> Rating <span
                                    class="text-red-400">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2" for="comment">
                                <i class="fa-solid fa-comment text-[#B78A58] mr-1"></i> Ulasan <span
                                    class="text-red-400">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                <i class="fa-solid fa-image text-[#B78A58] mr-1"></i> Foto atau Video (opsional)
                            </label>
                            <div class="flex items-start gap-4">
                                <div id="imagePreviewWrapper">
                                    <img id="imagePreview" src="#" alt="Preview" class="hidden">
                                    <video id="videoPreview" class="hidden" muted controls></video>
                                    <button type="button" id="removeImg" title="Hapus file">
                                        <i class="fa-solid fa-xmark fa-2xs"></i>
                                    </button>
                                </div>
                                <label for="image"
                                    class="file-drop-zone flex-1 flex flex-col items-center justify-center gap-2 py-6 px-4 rounded-xl bg-white text-gray-400 text-sm text-center">
                                    <i class="fa-solid fa-cloud-arrow-up text-2xl text-[#B78A58]/60"></i>
                                    <span>Klik atau seret file ke sini</span>
                                    <span class="text-xs text-gray-300">JPG, PNG, GIF, MP4 — maks. 20 MB</span>
                                    <input type="file" id="image" name="image" accept="image/*,video/mp4,video/webm" class="sr-only">
                                </label>
                            </div>
